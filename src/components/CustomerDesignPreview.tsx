...
export default function CustomerDesignPreviewModal({
  isOpen,
  onClose,
  previewUrl,
  keycapColor,
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = url;
      link.download = "customer_design_preview.png";
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-xl w-[600px] max-w-full p-4 relative">
        ...
        <h2 className="text-lg font-semibold mb-4">Customer Design Preview</h2>
